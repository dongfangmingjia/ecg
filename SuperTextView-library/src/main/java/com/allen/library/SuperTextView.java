...
public class SuperTextView extends RelativeLayout {
    ...
    private SpannableString leftTextColorSpanString;//左边分颜色显示的文字
    ...
    private static final int DEFAULT = NONE;
    ...
    private boolean mRightIconIsClickable = false;
    private boolean isLeftStringColorSpan = false;
...
//        defaultLinePadding = dip2px(context, 16);
    ...
    private void getAttr(AttributeSet attrs) {
        ...
        mRightIconIsClickable = typedArray.getBoolean(R.styleable.SuperTextView_sRightIconIsClickable, false);
    ...
    /**
     * 设置分割线的显示位置
     * @param lineType 分割线的显示方式0:none、1:top、2:bottom、3:both
     * @return
     */
    public SuperTextView setLineType(int lineType) {
        switch (lineType) {
            case NONE:
                setLine();
                break;
    ...
    private void initTopLine(int lineMarginLeft, int lineMarginRight, int lineWidth) {
        ...
        mTopLine.setLayoutParams(topLineParams);
    ...
    private void initLeftText() {
        ...
        if(isLeftStringColorSpan)
            leftTV.setText(leftTextColorSpanString);
        else
    ...
    private void initRightText() {
        ...
        rightTV.setGravity(Gravity.RIGHT|Gravity.CENTER_VERTICAL);
     ...
     * @return 返回对象
     */
    public SuperTextView setLeftColorSpanString(SpannableString leftString) {
        isLeftStringColorSpan = true;
        leftTextColorSpanString = leftString;
        if (leftTV == null) {
            initLeftText();
        } else {
            leftTV.setText(leftTextColorSpanString);
	 ...
	 * 设备中间文字的大小
	 *
	 * @param centerStringSize 中间文字的大小
	 * @return 返回对象
	 */
	public SuperTextView setCenterStringSize(float centerStringSize) {
		centerTV.setTextSize(centerStringSize);
		return this;
	}
     ...
     * @return 返回对象
     */
    public SuperTextView setCenterTVColor(int textColor) {
     ...
     * @return 返回
     */
    public SuperTextView setRightIconIsClickable(boolean isClickable) {
        if (isClickable) {
            if (rightIconIV != null) {
                rightIconIV.setOnClickListener(new OnClickListener() {
                    @Override
